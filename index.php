...
<html lang="en">
    <head>
        ...
        <link href="../Gestion_Biblio/public/css/styles.css" rel="stylesheet" />
        <style>
            header.img{
                    ...
                    <div class="col-lg-4 col-sm-6 mb-4"> -->
                        ...
                        <!-- <div class="portfolio-item">
                            <a class="portfolio-link" data-bs-toggle="modal" href="#portfolioModal1">
                                ...
                                <img class="img-fluid" src="public/img/télécharger.jfif" alt="..." />
                            </a>
         ...
         <div class="col-3  ">
            ...
            <div class="card-body">
                ...
                <a href="uploads/files/<?= $book['file'] ?>" class="btn btn-primary"
                    ...
                    <a class="btn btn-dark btn-sm " href="views/user/reserveBook.php?id=<?= $book['id']?>">Reserve Now</a>
